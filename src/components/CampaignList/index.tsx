...
const CampaignList = () => {
    const initialCampaigns = [
        ...
        },
        {
            ...
            "description": "Dive into a new dimension with StellarVR, a groundbreaking virtual reality experience that combines cutting-edge graphics and immersive storytelling. Join us on this cosmic journey through the stars and beyond!",
            "daysLeft": "35 days",
            "totalRaised": "120 ETH",
            "totalGoal": "250 ETH",
            "category": "Entertainment",
            image: "https://images.unsplash.com/photo-1592478411213-6153e4ebc07d?q=80&w=1412&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
    ...
    useEffect(() => {
        ...
        setCampaigns(initialCampaigns.filter(campaign => campaign.title.includes(search)))
    }, [search]);
